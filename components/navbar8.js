            ...
            <div className="navbar8-buttons1">
              <button className="navbar8-action11 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text15">Explore Products</span>
                    </Fragment>
                  )}
                </span>
              </button>
                              ...
                              {props.page2Description ?? (
                                <Fragment>
                                  <span className="navbar8-text23 thq-body-small">
                                    Learn more about Raga Tex India Private
                                    Limited and our journey in the Home Textiles
                                    industry.
                                  </span>
                                </Fragment>
                              )}
                              ...
                              {props.page3Description ?? (
                                <Fragment>
                                  <span className="navbar8-text26 thq-body-small">
                                    Explore our wide range of high-quality home
                                    textile products.
                                  </span>
                                </Fragment>
                              )}
                    ...
                    <div className="navbar8-content5">
                      ...
                      <span>
                        {props.page1Description ?? (
                          <Fragment>
                            <span className="navbar8-text22 thq-body-small">
                              Welcome to Raga Tex India Private Limited - Your
                              Home Textiles Partner
                            </span>
                          </Fragment>
                        )}
                      </span>
                    ...
                    <div className="navbar8-content6">
                      ...
                      <span>
                        {props.page2Description ?? (
                          <Fragment>
                            <span className="navbar8-text23 thq-body-small">
                              Learn more about Raga Tex India Private Limited
                              and our journey in the Home Textiles industry.
                            </span>
                          </Fragment>
                        )}
                      </span>
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1723907193776-f5ea4656bb41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODQ0Nzg5OHw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'About Us Image',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Raga Tex India Private Limited',
  logoSrc:
  ...
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1606681246594-372e9e133ac1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODQ0NzkwMHw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1582741789041-a1738cc8bd18?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODQ0NzkwMHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1486548730767-5c679e8eda6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODQ0NzkwMXw&ixlib=rb-4.0.3&q=80&w=1080',
