            ...
            <div className="steps2-container3">
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text25 thq-body-small">
                        Raga Tex India Private Limited has its Corporate Office
                        and sewing unit located at Coimbatore, India.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text28 thq-body-small">
                        The company&apos;s location near textile centers like
                        Palladam, Tirupur, Erode, Salem, and Karur provides easy
                        access to raw materials and sourcing needs.
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text26 thq-body-small">
                        Raga Tex India Private Limited has set up a weaving unit
                        at Jambai, near Bhavani at Erode, Tamil Nadu.
                      </span>
                    </Fragment>
                  )}
                </span>
              ...
              <div className="steps2-container7 thq-card">
                <h2>
                  {props.step4Title ?? (
                    <Fragment>
                      <h2 className="steps2-text32 thq-heading-2">Step 4</h2>
                    </Fragment>
                  )}
                </h2>
                <span>
